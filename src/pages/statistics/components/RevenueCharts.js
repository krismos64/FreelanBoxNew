...
const RevenueCharts = ({ monthlyData, yearlyRevenue, dateRange, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6", children: [(0, jsx_runtime_1.jsx)("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-6", children: "\u00C9volution du chiffre d'affaires" }), (0, jsx_runtime_1.jsx)("div", { className: "h-[400px]", children: (0, jsx_runtime_1.jsx)(react_chartjs_2_1.Line, { ref: chartRef, data: data, options: options }) })] }));
};
exports.RevenueCharts = RevenueCharts;
